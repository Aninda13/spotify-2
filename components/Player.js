...
import { FastForwardIcon, PlayIcon, PauseIcon, RewindIcon, VolumeUpIcon } from '@heroicons/react/solid';
...
function Player() {
    ...
    // Debounce is used to prevent the volume from being set too often
    // So it waits 500ms(from the moment the slider is let go off) before setting the volume
    // so api calls are not made too often while the slider is being dragged
